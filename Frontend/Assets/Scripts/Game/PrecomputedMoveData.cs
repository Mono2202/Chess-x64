            ...
            for (int squareIndex = 0; squareIndex < 64; squareIndex++)
            {
                ...
                if (x > 0)
                {
                    if (y < 7)
                    {
                        ...
                        pawnAttackBitboards[squareIndex][Board.WHITE_INDEX] |= 1ul << (squareIndex + 7);
                    }
                    if (y > 0)
                    {
                        pawnCapturesBlack.Add(squareIndex - 9);
                        pawnAttackBitboards[squareIndex][Board.BLACK_INDEX] |= 1ul << (squareIndex - 9);
                    }
                }
                if (x < 7)
                {
                    if (y < 7)
                    {
                        ...
                        pawnAttackBitboards[squareIndex][Board.WHITE_INDEX] |= 1ul << (squareIndex + 9);
                    }
                    if (y > 0)
                    {
                        pawnCapturesBlack.Add(squareIndex - 7);
                        pawnAttackBitboards[squareIndex][Board.BLACK_INDEX] |= 1ul << (squareIndex - 7);
                    }
                }
